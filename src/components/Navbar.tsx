...
function Navbar() {
    return (
        <nav className='w-full h-20 flex items-center justify-around z-10 text-black shadow-lg'>
            ...
            <div className='relative'>
                <input type="text" className='px-5 py-2 rounded-full pr-10 text-black outline-none border-2' placeholder='Search' />
                ...
                <Link to='/login'><i className="fa-solid fa-circle-user text-3xl ml-7 translate-y-1"></i></Link>
            </div>
        </nav>
    )
}
