...
function HomePage() {
    ...
    return (
        <>
            <NavbarHome />
            <div className='relative -translate-y-20 -z-10 flex'>
                <img src={Image} alt="" className='w-full h-screen object-cover' />
                <div className={`bg-black bg-opacity-50 absolute top-80 left-40 p-10 rounded-xl transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
