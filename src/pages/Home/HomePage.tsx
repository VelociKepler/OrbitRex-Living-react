...
function HomePage() {
    ...
    return (
        <>
            ...
            <div className={`hidden lg:bg-black lg:bg-opacity-50 lg:absolute lg:top-80 lg:left-40 lg:p-10 lg:rounded-xl lg:transition-all lg:duration-1000 ${isVisible ? 'lg:opacity-100' : 'lg:opacity-0 lg:translate-y-10'}`}>
